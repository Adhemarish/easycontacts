...
tg5 = Tag.create!(user: ludo, label: 'Freelance', color: 'purple-tag')
...
tg12 = Tag.create!(user: ludo, label: 'Oenologie', color: 'purple-tag')
...
tg19 = Tag.create!(user: ludo, label: 'Ecommerce', color: 'purple-tag')
...
ntag20 = NoteTag.create!(tag: tg20, note: nt13)
